...
n_rows: int = 100  # Change Value Here
...
# Generate Random Number: rand_no = random.sample(range(1, obj_length), n_rows)
rand_no = []
if n_rows <= obj_length:
    rand_no = [random.randrange(1, obj_length, 1) for i in range(n_rows)]
